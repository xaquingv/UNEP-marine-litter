...
var app = (function () {
    ...
    function create_fragment$j(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*noscroll*/ ctx[5]) return create_if_block$a;
    ...
    function create_fragment$h(ctx) {
    	...
    	let if_block = /*intersecting*/ ctx[6] && create_if_block$9(ctx);
    ...
    function create_foreground_slot$2(ctx) {
    	let div;
    	let t;
    	let if_block = /*head*/ ctx[1] && create_if_block$5(ctx);
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$7, 42, 24, 961);
    			attr_dev(p, "class", "download svelte-1y2v0ot");
    			add_location(p, file$7, 42, 4, 941);
    			attr_dev(ul, "class", "lang-menu svelte-1y2v0ot");
    			add_location(ul, file$7, 43, 4, 1014);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, a);
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "class", "svelte-1y2v0ot");
    			add_location(a, file$7, 38, 27, 865);
    			attr_dev(li, "class", "download svelte-1y2v0ot");
    			add_location(li, file$7, 38, 6, 844);
    			attr_dev(ul, "class", "svelte-1y2v0ot");
    			add_location(ul, file$7, 34, 4, 739);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-1y2v0ot");
    			add_location(a, file$7, 45, 14, 1084);
    			attr_dev(li, "class", "svelte-1y2v0ot");
    			add_location(li, file$7, 45, 10, 1080);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, a);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(45:10) {#each languages as l}",
    		ctx
    	});
    ...
    function create_each_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "?lang=" + /*l*/ ctx[13].id);
    			attr_dev(a, "class", "svelte-1y2v0ot");
    			add_location(a, file$7, 36, 10, 783);
    			attr_dev(li, "class", "svelte-1y2v0ot");
    			add_location(li, file$7, 36, 6, 779);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, a);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:6) {#each languages as l}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*desktop*/ ctx[8]) return create_if_block$4;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$7, 24, 0, 562);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	binding_callbacks.push(() => bind(intersectionobserver, "intersecting", intersectionobserver_intersecting_binding));
    	let if_block = /*intersecting*/ ctx[4] && create_if_block$3(ctx);
    ...
    function create_default_slot(ctx) {
    	...
    	let if_block = /*p*/ ctx[0].illo && create_if_block$2(ctx);
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$1, 17, 20, 441);
    			attr_dev(li, "class", "label svelte-1bjint7");
    			add_location(li, file$1, 17, 2, 423);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, a);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:2) {#each resources as r}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1bjint7");
    			add_location(img, file$1, 11, 42, 240);
    			attr_dev(a0, "class", "img_link svelte-1bjint7");
    			...
    			add_location(h41, file$1, 14, 2, 366);
    			attr_dev(ul, "class", "svelte-1bjint7");
    			add_location(ul, file$1, 15, 2, 391);
    			attr_dev(a2, "href", /*furtherlink*/ ctx[6]);
    			add_location(a2, file$1, 20, 6, 530);
    			add_location(h42, file$1, 20, 2, 526);
    			add_location(section0, file$1, 13, 2, 354);
    			attr_dev(section1, "class", "col-text border svelte-1bjint7");
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*other*/ 8) h41.innerHTML = /*other*/ ctx[3];
    		...
    		resources: [
    			{
    				...
    				link: "Fig_1_The Risks & Impacts.pdf"
    			},
    			{
    				label: "Bio and plastic",
    				link: "Fig_2_Bio_and_plastic.pdf"
    			},
    			{
    				label: "Harm to humans",
    				link: "Fig_3_Harm to Humans.pdf"
    			},
    			{
    				label: "Pathways landscape",
    				link: "Fig_4_Pathways_Landscape_2_parts.pdf"
    			},
    			{
    				label: "Agriculture",
    				link: "Fig_5_Agriculture.pdf"
    			},
    			{
    				label: "The contribution of fisheries and aquaculture",
    				link: "Fig_6_The Contribution of Fisheries & Aquaculture.pdf"
    			},
    			{
    				label: "Sediments microplastic",
    				link: "Fig_7_Sediments_microplatic.pdf"
    			},
    			{
    				label: "Timeline",
    				link: "Fig_9_Time_line.pdf"
    			},
    			{
    				label: "Changing attitudes",
    				link: "Fig_10_Changing Attitudes?.pdf"
    			}
    		]
    	},
    	{
    ...
    var article$4 = [
    	...
    	},
    	{
    		...
    		resources: [
    			...
    			{
    				label: "Bio et plastique",
    				link: "Fig_2_Bio_and_plastic.pdf"
    			},
    			{
    				label: "Effets néfastes sur les êtres humains",
    				link: "Fig_3_Harm to Humans.pdf"
    			},
    			{
    				label: "Paysage des trajectoires",
    				link: "Fig_4_Pathways_Landscape_2_parts.pdf"
    			},
    			{
    				label: "Agriculture",
    			...
    			{
    				label: "La contribution des pêcheries et de l’aquaculture",
    				link: "Fig_6_The Contribution of Fisheries & Aquaculture.pdf"
    			},
    			{
    				label: "Les sédiments et les microplastiques",
    				link: "Fig_7_Sediments_microplatic.pdf"
    			},
    			{
    				label: "Chronologie",
    			...
    			{
    				label: "Faire évoluer les attitudes",
    				link: "Fig_10_Changing Attitudes.pdf"
    			}
    		]
    	},
    ...
    var article$3 = [
    	...
    	},
    	{
    		...
    		resources: [
    			...
    			{
    				label: "التحلل البيولوجي والبلاستيك",
    				link: "Fig_2_Bio_and_plastic.pdf"
    			},
    			{
    				label: "الإضرار بالبشر",
    				link: "Fig_3_Harm to Humans.pdf"
    			},
    			{
    				label: "مشهد المسارات",
    			...
    			{
    				label: "مساهمة مصائد الأسماك والاستزراع المائي",
    				link: "Fig_6_The Contribution of Fisheries & Aquaculture.pdf"
    			},
    			{
    				label: "رواسب المواد البلاستيكية الدقيقة",
    				link: "Fig_7_Sediments_microplatic.pdf"
    			},
    			{
    				label: "الجدول الزمني",
    ...
    var article$2 = [
    	...
    	},
    	{
    		...
    		resources: [
    			...
    			{
    				label: "Биология и пластик",
    				link: "Fig_2_Bio_and_plastic.pdf"
    			},
    			{
    				label: "Ущерб, наносимый человечеству",
    				link: "Fig_3_Harm to Humans.pdf"
    			},
    			{
    				label: "Ландшафт путей",
    				link: "Fig_4_Pathways_Landscape_2_parts.pdf"
    			},
    			{
    			...
    			{
    				label: "Вклад рыболовства и аквакультуры",
    				link: "Fig_6_The Contribution of Fisheries & Aquaculture.pdf"
    			},
    			{
    				label: "Отложения микропластика",
    				link: "Fig_7_Sediments_microplatic.pdf"
    			},
    			{
    		...
    		resources: [
    			{
    				...
    				link: "Picha_1_ Hatari na athari.pdf"
    			},
    			{
    				label: "Bio na plastiki",
    				link: "Picha_2_ Bio _na_ plastiki.pdf"
    			},
    			{
    				label: "Madhara kwa wanadamu",
    				link: "Picha_3_Hatari kwa Wanadamu.pdf"
    			},
    			{
    				label: "Njia ya Mazingira",
    				link: "Picha_4_Njia ya_Mazingira sehemu_2_.pdf"
    			},
    			{
    				label: "Kilimo",
    				link: "Picha_5_Kilimo.pdf"
    			},
    			{
    				label: "Mchango wa uvuvi na ufugaji samaki",
    				link: "Picha_6_ Mchango wa uvuvi na ufugaji samaki.pdf"
    			},
    			{
    				label: "Vipande vya mikroplastiki",
    				link: "Picha_7_Vipande vya_mikroplastiki.pdf"
    			},
    			{
    				label: "Ratiba ya nyakati",
    				link: "Picha_9_ Ratiba ya _ nyakati.pdf"
    			},
    			{
    				label: "Kubadilisha mitazamo",
    				link: "Picha_10_ Kubadilisha mitazamo.pdf"
    			}
    		]
    	},
    	{
