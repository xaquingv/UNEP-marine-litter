...
Marine litter and plastic pollution are problematic for many reasons. Plastics don’t biodegrade (decompose naturally in a way that’s not harmful to the environment). Instead, they break down over time into ever smaller pieces known as microplastics and nanoplastics, particles ranging from 5 millimetres long to less than a few nanometres in size, which can have unquantifiable adverse impacts. Some of the most heartbreaking images attest to the harm it inflicts on marine animals.
...
Deal with the legacy through effective monitoring to identify sources, quantities and fate plastic.
...
The <a href="">Global Partnership on Marine Litter (GPML)</a> brings together all actors working on marine litter and plastic pollution prevention and reduction. Join the GPML here!


The GPML Digital Platform is an open-source, multi-stakeholder platform that compiles different resources, connects stakeholders and integrates data to guide action. Join the platform here. supports the operationalization of the partnership by serving as an open-source, multi-stakeholder platform that compiles different resources, connects stakeholders and integrates data to guide action with the goal of an accessible ocean with open and equitable access to data, information and technology and innovation.


Committed to drive applied science and solutions over the next 10 years to support the ocean we want through the Decade on Ocean Science for Sustainable Development and UN Decade on Ecosystem Restoration.


The Clean Seas Campaign aims to reduce single-use, unnecessary and avoidable plastics from source to sea and to promote circular approach solutions.


Rooted in the long-standing work of UNEP and the <a href="">Global Partnership on Marine Litter (GPML)</a>, Clean Seas targets individuals to take action in their own behavior and to move markets through their purchase decisions; businesses to invest and fast track innovation; and governments to increase their levels of ambition and urgency, tighten regulations and better inform their citizenry. Sixty-three countries are signatories to the Clean Seas campaign and over one million individuals have pledged to take personal action.


Find out more on how to join and take the #CleanSeas pledge <a href="">here</a>.
